...
public abstract class EnumeratedType extends StringValue {
     ...
     */
    private static final Map<String, List<EnumeratedType>> valueListByClass = new ConcurrentHashMap<>();

    /**
     * Constructor.
     *
     * @param name Name of this enumerated type value
     */
     ...
     *
     * @param c The enumerated type subclass to get values for
     * @return List of all values of the given subclass
     */
    public static List<EnumeratedType> getValues(final Class<?> c) {
    ...
    public Object readResolve() throws java.io.ObjectStreamException {
        ...
        if (values != null) {
            for (EnumeratedType type : values) {
                if (type.toString() != null
                        && type.toString().equals(this.toString())) {
                    result = type;
                    break;
                }
            }
