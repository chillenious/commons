...
/**
 * Converts to {@link java.util.Calendar}.
 */
public class CalendarConverter implements IConverter<Calendar> {
     ...
     * Construct.
     *
     * @param dateConverter delegated converter, not null
     */
    ...
    /**
     * @see com.chillenious.common.util.convert.IConverter#convertToObject(String,
     * java.util.Locale)
     */
    @Override
    ...
    /**
     * @see com.chillenious.common.util.convert.IConverter#convertToString(Object,
     * java.util.Locale)
     */
    @Override
