...
public class SqlTimestampConverter extends AbstractDateConverter<Timestamp> {
     ...
     * Construct.
     *
     * @param dateFormat See java.text.DateFormat for details. Defaults to DateFormat.SHORT
     */
     ...
     * Construct.
     *
     * @param dateFormat See java.text.DateFormat for details. Defaults to DateFormat.SHORT * @param
