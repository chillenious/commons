 ...
 * <ul>
 * <li><code>valueOf(long)</code> where <code>long</code> is milliseconds since
 * midnight
 * <li><code>valueOf(String)</code> where the <code>String</code> is in 'h.mma'
 * format
 * <li><code>valueOf(Calendar, String)</code> where the <code>String</code> is
 * in 'h.mma' format
 * <li><code>valueOf(Duration)</code> where <code>Duration</code> is time since
 * midnight
 * <li><code>valueOf(Time)</code> where <code>Time</code> is some point in time
 * today
 * <li><code>valueOf(Calendar, Time)</code> where <code>Time</code> is some
 * point in time today
 * <li><code>militaryTime(int hour, int minute, int second)</code> for 24-hour
 * time
 ...
 * <li><code>now(Calendar)</code> to construct the current time of day using a
 ...
 * calling the <code>hour</code>, <code>minute</code>, and <code>second</code>
 * methods.
 * <p/>
 * The next occurrence of a given <code>TimeOfDay</code> can be retrieved by
 * calling <code>next()</code> or <code>next(Calendar)</code>.
 *
...
public final class TimeOfDay extends AbstractTime {
     ...
     */
    public static TimeOfDay militaryTime(final int hour, final int minute,
                                         final int second) {
        if ((hour > 23) || (hour < 0)) {
     ...
     */
    public static TimeOfDay time(final int hour, final int minute,
                                 final int second, final Meridian meridian) {
        if (meridian == PM) {
            if (hour == 12) {
     ...
     *
     * @param calendar the <code>Calendar</code> to use when parsing time
     *                 <code>String</code>
     * @param time     a <code>String</code> in 'h.mma' format
     ...
     *
     * @param calendar the <code>Calendar</code> to use
     * @param time     a <code>Time</code> instance
     * @return the <code>TimeOfDay</code> on the given <code>Calendar</code>
     */
     ...
     * instance.
     *
     * @param duration the <code>Duration</code> to use
     ...
     * instance.
     *
     * @param time a <code>Time</code> to convert to <code>TimeOfDay</code>
     ...
     *
     * @param time the time today in milliseconds
     */
