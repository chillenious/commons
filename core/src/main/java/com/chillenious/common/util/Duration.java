...
/**
 * A <code>Duration</code> is an immutable length of time stored as a number of
 ...
 * </ul>
 * <p/>
 * In the case of <code>milliseconds(double)</code>, the value will be rounded
 * off to the nearest integral millisecond using <code>Math.round()</code>.
 * <p/>
 ...
 * <p/>
 * <code>String</code> values can be converted to <code>Duration</code> objects
 * using the static <code>valueOf</code> factory methods. The
 * <code>String</code> format is the opposite of the one created by
 * <code>toString()</code>, which converts a <code>Duration</code> object to a
...
public class Duration extends AbstractTimeValue {
     ...
     *
     * @param code a <code>Runnable</code>
     ...
     *
     * @param days days <code>double</code> value
     ...
     * Retrieves the <code>Duration</code> based on days.
     *
     * @param days days <code>int</code> value
     * @return the <code>Duration</code> based on days
     */
     ...
     *
     * @param start the start <code>Time</code>
     * @return the elapsed period as a <code>Duration</code>
     * @throws IllegalStateException if start <code>Time</code> is in the future
     */
     ...
     *
     * @param hours hours <code>double</code> value
     ...
     * Retrieves the <code>Duration</code> based on hours.
     *
     * @param hours hours <code>int</code> value
     * @return the <code>Duration</code> based on hours
     */
     ...
     *
     * @param milliseconds milliseconds <code>double</code> value
     ...
     * Retrieves the <code>Duration</code> based on milliseconds.
     *
     * @param milliseconds milliseconds <code>long</code> value
     * @return the <code>Duration</code> based on milliseconds
     */
     ...
     *
     * @param minutes minutes <code>double</code> value
     ...
     * Retrieves the <code>Duration</code> based on minutes.
     *
     * @param minutes minutes <code>int</code> value
     * @return the <code>Duration</code> based on minutes
     */
     ...
     *
     * @param seconds seconds <code>double</code> value
     ...
     * Retrieves the <code>Duration</code> based on seconds.
     *
     * @param seconds seconds <code>int</code> value
     * @return the <code>Duration</code> based on seconds
     */
     ...
     *
     * @param time the duration <code>long</code> value in milliseconds
     ...
     *
     * @param string a <code>String</code> to parse
     ...
     *
     * @param string a <code>String</code> to parse
     * @param locale the <code>Locale</code> used for parsing
     * @return the <code>Duration</code> value of the given <code>String</code>
     * @throws StringValueConversionException
     */
    public static Duration valueOf(final String string, final Locale locale)
        ...
        if (matcher.matches()) {
            final double value = StringValue.valueOf(matcher.group(1), locale)
                    .toDouble();
            ...
            if (units.equalsIgnoreCase("millisecond")) {
                ...
                throw new StringValueConversionException("Unrecognized units: "
                        + string);
            }
        } else {
     ...
     *
     * @param that the <code>Duration</code> to subtract
