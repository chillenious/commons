...
public class Args {
     ...
     *
     * @param <T>      the type of the argument to check for emptiness
     * @param argument the argument to check for emptiness
     * @param name     the name to use in the error message
     * @return The {@code argument} parameter if not empty
     * @throws IllegalArgumentException when the passed {@code argument} is empty
     */
     ...
     * @param message
     * @param params
     * @throws IllegalArgumentException if the passed collection is either null or empty
     */
