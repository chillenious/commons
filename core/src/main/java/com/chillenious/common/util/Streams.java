...
public final class Streams {
     ...
     *
     * @param properties  The object to load the properties into
     * @param inputStream
     * @throws java.io.IOException When the input stream could not be read from
     */
     ...
     * @throws java.io.IOException when a connection cannot be opened
     */
