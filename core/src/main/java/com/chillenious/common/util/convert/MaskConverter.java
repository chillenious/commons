...
import com.chillenious.common.util.Args;
...
/**
 * A converter that takes a mask into account. It uses an instance of {@link javax.swing.text.MaskFormatter} to delegate
...
public class MaskConverter<C> implements IConverter<C>
{
	...
	/**
	 * Converts a string to an object using {@link javax.swing.text.MaskFormatter#stringToValue(String)}.
	 */
	@Override
	...
	/**
	 * Converts the value to a string using {@link javax.swing.text.MaskFormatter#valueToString(Object)}.
	 */
	@Override
