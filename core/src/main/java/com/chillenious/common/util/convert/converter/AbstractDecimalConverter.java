...
public abstract class AbstractDecimalConverter<N extends Number> extends AbstractNumberConverter<N> {
    ...
    /**
     * Creates a new {@link java.text.NumberFormat} for the given locale. The instance is later cached and is
     * accessible through {@link #getNumberFormat(java.util.Locale)}
     *
     * @param locale
    ...
    /**
     * @param locale       The Locale that was used for this NumberFormat
