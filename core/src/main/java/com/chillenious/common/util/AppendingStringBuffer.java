...
public final class AppendingStringBuffer
     ...
     * @throws NegativeArraySizeException if the <code>length</code> argument is less than
     *                                    <code>0</code>.
     */
     ...
     * current length, sufficient null characters (<code>'&#92;u0000'</code>) are appended to the
     * string buffer so that length becomes the <code>newLength</code> argument.
     * <p/>
     ...
     *                                   </code> is negative <li>the <code>srcBegin</code> argument
     *                                   is greater than the <code>srcEnd</code> argument. <li>
     *                                   <code>srcEnd</code> is greater than <code>this.length()
     *                                   </code>, the current length of this string buffer. <li>
     *                                   <code>dstBegin+srcEnd-srcBegin</code> is greater than
     ...
     * new character sequence is equal to the character at index <i>k</i> in the
     * old character sequence, if <i>k</i> is less than <i>n</i>; otherwise, it
     * is equal to the character at index <i>k-n</i> in the argument
     * <code>str</code>.
     *
     * @param str a string.
     ...
     * <tt>sb</tt> is <tt>null</tt>, then the four characters <tt>"null"</tt>
     * are appended to this <tt>AppendingStringBuffer</tt>.
     * <p/>
     * Let <i>n</i> be the length of the old character sequence, the one
     ...
     * the new character sequence is equal to the character at index <i>k</i> in
     * the old character sequence, if <i>k</i> is less than <i>n</i>; otherwise,
     ...
     *
     * @param sb the <tt>AppendingStringBuffer</tt> to append.
     ...
     * <code>AppendingStringBuffer</code>. The substring begins at the specified
     ...
     * the <code>AppendingStringBuffer</code>.
     *
     * @param start The beginning index, inclusive.
     ...
     * </blockquote>
     * <p/>
     * This method is provided so that the <tt>AppendingStringBuffer</tt> class
     * can implement the {@link CharSequence} interface.
     * </p>
     *
     ...
     * @return The new string.
     * @throws StringIndexOutOfBoundsException
     *          if <code>start</code> or <code>end</code> are negative or
     *          greater than <code>length()</code>, or <code>start</code>
     ...
     * <code>AppendingStringBuffer</code> increases by <code>len</code>
     * characters.
     *
     * @param index  position at which to insert subarray.
     * @param str    A character array.
     * @param offset the index of the first character in subarray to to be
     *               inserted.
     ...
     */
    public AppendingStringBuffer insert(int index, char str[], int offset,
                                        int len) {
        if ((index < 0) || (index > count)) {
            throw new StringIndexOutOfBoundsException();
        }
     ...
     * @see String#valueOf(Object)
     * @see com.chillenious.common.util.AppendingStringBuffer#insert(int, String)
     * @see com.chillenious.common.util.AppendingStringBuffer#length()
     */
    ...
    public int lastIndexOf(String str, int fromIndex) {
        return lastIndexOf(value, 0, count, str.toCharArray(), 0, str.length(),
                fromIndex);
    }
     ...
     *         this AppendingStringBuffer; <code>false</code> otherwise. Note
     *         that the result will be <code>true</code> if the argument is the
     ...
     * A new <code>String</code> object is allocated and initialized to contain
     * the character sequence currently represented by this string buffer. This
     ...
     * is <code>true</code> if and only if the argument is not <code>null</code>
     * and is a <code>AppendingStringBuffer</code> object or another
     * charsequence object! that represents the same sequence of characters as
     * this object.
     *
     * @param anObject the object to compare this <code>AppendingStringBuffer</code>
     *                 against.
     ...
     * is the <i>i</i>th character of the AppendingStringBuffer, <code>n</code>
     * is the length of the AppendingStringBuffer, and <code>^</code> indicates
     * exponentiation. (The hash value of the empty AppendingStringBuffer is
     * zero.)
     *
