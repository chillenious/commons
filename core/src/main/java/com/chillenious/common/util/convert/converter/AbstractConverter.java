...
import com.chillenious.common.util.convert.ConversionException;
...
public abstract class AbstractConverter<C> implements IConverter<C> {
     ...
     * @return The object
     * @throws ConversionException Thrown if parsing fails
     */
     ...
     * @param value   The value that didn't convert
    ...
    /**
     * @see com.chillenious.common.util.convert.IConverter#convertToString(Object, java.util.Locale)
     */
    @Override
