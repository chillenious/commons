...
import com.chillenious.common.util.convert.converter.BigDecimalConverter;
import com.chillenious.common.util.convert.converter.BigIntegerConverter;
import com.chillenious.common.util.convert.converter.BooleanConverter;
import com.chillenious.common.util.convert.converter.ByteConverter;
import com.chillenious.common.util.convert.converter.CalendarConverter;
import com.chillenious.common.util.convert.converter.CharacterConverter;
import com.chillenious.common.util.convert.converter.DateConverter;
import com.chillenious.common.util.convert.converter.DoubleConverter;
import com.chillenious.common.util.convert.converter.FloatConverter;
import com.chillenious.common.util.convert.converter.IntegerConverter;
import com.chillenious.common.util.convert.converter.LongConverter;
import com.chillenious.common.util.convert.converter.ShortConverter;
import com.chillenious.common.util.convert.converter.SqlDateConverter;
import com.chillenious.common.util.convert.converter.SqlTimeConverter;
import com.chillenious.common.util.convert.converter.SqlTimestampConverter;
...
public class ConverterLocator implements IConverterLocator {
    ...
    private static class DefaultConverter<C> implements IConverter<C> {
        ...
        /**
         * @see IConverter#convertToObject(String,
         * java.util.Locale)
         */
        @Override
        ...
        /**
         * @see IConverter#convertToString(Object,
         * java.util.Locale)
         */
        @Override
     ...
     *
     * @param <C> The object to convert from and to String
     * @param c   The class to get the type converter for
     ...
     *
     * @param type Class to get the converter for.
     * @return The converter for the given type
     * @see IConverter#convertToObject(String, java.util.Locale)
     */
    @Override
