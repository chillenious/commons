...
public class StringValue implements Serializable {
     ...
     *         decimal
     */
    public static StringValue valueOf(final double value, final int places,
                                      final Locale locale) {
     ...
     */
    public final String replaceAll(final String searchFor,
     ...
     */
    public final Object to(final Class<?> type)
            throws StringValueConversionException {
     ...
     *
     * @return <code>true</code> if the text is <code>null</code>,
