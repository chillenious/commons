 ...
 * time. The underlying representation is a <code>long</code> value which holds
 * a number of milliseconds since January 1, 1970, 0:00 GMT. To represent a
 * duration of time, such as "6 seconds", use the <code>Duration</code> class.
 * To represent a time period with a start and end time, use the
 * <code>TimeFrame</code> class. To represent a time of day, use the
 * <code>TimeOfDay</code> class.
 *
...
public final class Time extends AbstractTime {
     ...
     *
     * @param time the time value in milliseconds since START_OF_UNIX_TIME
     ...
     *
     * @param calendar the <code>Calendar</code> to use when parsing date
     *                 <code>String</code>
     ...
     * format.
     *
     * @param calendar the <code>Calendar</code> to use when parsing the
     *                 <code>String</code>
     * @param string   the <code>String</code> to parse
     * @return an immutable UNIX <code>Time</code> value
     * @throws java.text.ParseException
     */
    public static Time valueOf(final Calendar calendar, final String string)
            throws ParseException {
     ...
     *
     * @param calendar  the <code>Calendar</code> to use
     * @param timeOfDay the time of day
     * @return a <code>Time</code> value for the time of day today
     */
    public static Time valueOf(final Calendar calendar,
     ...
     *
     * @param date a <code>java.util.Date</code> object
     ...
     * Retrieves a <code>Time</code> instance based on the given milliseconds.
     *
     * @param time the <code>Time</code> value in milliseconds since
     *             START_OF_UNIX_TIME
     * @return a corresponding immutable <code>Time</code> object
     */
     ...
     * @throws java.text.ParseException
     */
    public static Time valueOf(final String string, final String pattern)
            throws ParseException {
     ...
     *
     * @param timeOfDay the time of day in local time
     * @return a <code>Time</code> value for the time of day today
     */
    ...
    /**
     * Adds the given <code>Duration</code> to this <code>Time</code> object,
     ...
     *         value
     * @throws IllegalStateException thrown if this <code>Time</code> value is in the future
     */
     ...
     *
     * @param calendar the <code>Calendar</code> to use
     * @param field    the <code>Calendar</code> field to get
     ...
     *
     * @param calendar the <code>Calendar</code> to get the field value from
     * @return the day of month field value
     */
     ...
     *
     * @param calendar the <code>Calendar</code> from which to get the field value
     * @return the minute field value
     */
    ...
    /**
     * Subtracts the given <code>Duration</code> from this <code>Time</code>
    ...
    public Duration subtract(final Time that) {
        return Duration
                .milliseconds(getMilliseconds() - that.getMilliseconds());
    }

    /**
     * Retrieves a <code>Date</code> object for this <code>Time</code> object. A
     * new <code>Date</code> object is always returned rather than attempting to
     * cache a date since <code>Date</code> is mutable.
     *
    ...
    /**
     * Converts this <code>Time</code> value to a date <code>String</code> using
     ...
     *
     * @param calendar the <code>Calendar</code> to use in the conversion
    ...
    public String toDateString(final Calendar calendar) {
        synchronized (dateFormat) {
            synchronized (calendar) {
                ...
                return dateFormat.format(new Date(getMilliseconds()))
                        .toLowerCase();
            }
        }
    }
    ...
    /**
     * Converts this <code>Time</code> value to a <code>String</code> suitable
    ...
    /**
     * Converts this <code>Time</code> object to a <code>String</code> using the
     * given <code>Calendar</code> and format.
     *
     * @param calendar the <code>Calendar</code> to use in the conversion
    ...
    /**
     * Converts this <code>Time</code> value to a <code>String</code> using the
     * given format.
     *
     * @param format the format to use
