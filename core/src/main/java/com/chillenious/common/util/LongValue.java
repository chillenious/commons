...
public class LongValue implements Comparable<LongValue>, Serializable {
     ...
     *
     * @param that the <code>Object</code> to compare with
     ...
     *
     * @param that the <code>LongValue</code> to compare with
     * @return <code>true</code> if this <code>LongValue</code> is greater than the given
     *         <code>LongValue</code>
     */
     ...
     * Compares this <code>LongValue</code> with a primitive <code>long</code> value.
     *
     * @param that the <code>long</code> value to compare with
     ...
     * Compares this <code>LongValue</code> with another <code>LongValue</code>.
     *
     * @param that the <code>LongValue</code> value to compare with
     * @return <code>true</code> if this <code>LongValue</code> is less than the given
     *         <code>LongValue</code>
     */
    ...
    /**
     * Null-safe version of {@link com.chillenious.common.util.LongValue#max}. Nulls are considered less then any concrete
     * value.
     *
     * @param <T>
     * @param lhs
